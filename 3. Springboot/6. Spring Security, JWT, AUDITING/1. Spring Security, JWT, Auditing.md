...
import uz.kiut.de_kiut_uz.entity.abs.AbsEntity;
import uz.kiut.de_kiut_uz.entity.enums.Gender;
...
import uz.kiut.de_kiut_uz.entity.User;
...
# 4.1 JwtProvider
```java
package uz.pdp.archvizor.security;
...
//                response.setStatus(401);
	...
	private User getUserFromToken(String token, HttpServletResponse response) {
        ...
        if (validateToken){
            UUID userIdFromToken = UUID.fromString(provider.getUserIdFromToken(token));
